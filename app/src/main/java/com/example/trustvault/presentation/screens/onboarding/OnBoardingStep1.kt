...
fun OnboardingStep1(
    ...
    Box(
        ...
        Column (
            ...
            val composition by rememberLottieComposition(LottieCompositionSpec.RawRes(R.raw.on_boarding_1_dark))
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Text(
                    text = "Contraseñas cifradas con un algoritmo líder en seguridad.",
                    fontSize = 16.sp,

        ...
        Column(
            ...
            Markdown(
                ...
                typography = markdownTypography(
                    h1 = TextStyle(fontSize = 22.sp, color = Color.White),
                    h2 = TextStyle(fontSize = 20.sp, color = Color.White),
                    text = TextStyle(fontSize = 16.sp, color = Color.White),
                    list = TextStyle(fontSize = 16.sp, color = Color.White)
                )
            )
        }
    }

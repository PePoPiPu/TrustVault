...
fun OnboardingStep3(
    ...
    Box(
        ...
        Column (
            ...
            val composition by rememberLottieComposition(LottieCompositionSpec.RawRes(R.raw.on_boarding_3))
            ...
            Column(horizontalAlignment = Alignment.CenterHorizontally) {
                ...
                Text(
                    text = "Protege tu cuenta con MFA, incluso si tu contraseña se filtra.",
                    fontSize = 16.sp,
